...
execute if data entity @s Inventory[{id:"minecraft:compass",tag:{LodestoneDimension:"minecraft:overworld"}}] run function manhunt:remove_compass_old
execute unless data entity @s Inventory[{id:"minecraft:compass",tag:{LodestoneDimension:"minecraft:the_nether"}}] run give @s minecraft:compass{LodestoneDimension:"minecraft:the_nether",LodestoneTracked:0b,Manhunt_tracker:1b}

#Cludge to handle not been in nether yet
#Need to be below give
...
execute if score Temp reg_1 matches 1 run function manhunt:set_compass_nether_old
