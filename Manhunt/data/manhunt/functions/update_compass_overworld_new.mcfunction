...
execute if score Temp reg_1 matches 1 run function manhunt:set_compass_overworld_new with storage manhunt:compass_data
execute if score Temp reg_1 matches 0 run function manhunt:go_mad_new
