...
execute as @e[team=runners] run scoreboard players operation @s manhunt_x -= @s manhunt_x_nether
execute as @e[team=runners] run scoreboard players operation @s manhunt_y -= @s manhunt_y_nether
execute as @e[team=runners] run scoreboard players operation @s manhunt_z -= @s manhunt_z_nether
...
execute store result storage manhunt:compass_data X int 1 run scoreboard players get @e[tag=manhunt_closest,limit=1] manhunt_x_nether
execute store result storage manhunt:compass_data Y int 1 run scoreboard players get @e[tag=manhunt_closest,limit=1] manhunt_y_nether
execute store result storage manhunt:compass_data Z int 1 run scoreboard players get @e[tag=manhunt_closest,limit=1] manhunt_z_nether
