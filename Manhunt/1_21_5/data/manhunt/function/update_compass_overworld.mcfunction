...
execute unless score @s manhunt_tid = @e[tag=manhunt_closest,limit=1] manhunt_rid run tellraw @s ["",{text:"Now tracking: ",bold:true,color:"gold"},{selector:"@e[tag=manhunt_closest]"}]
